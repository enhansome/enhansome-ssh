...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,561 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,223 | 🐛 100 | 🌐 Go | 📅 2026-09-20 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,223 | 🐛 100 | 🌐 Go | 📅 2026-09-20 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,938 | 🐛 3,229 | 🌐 Go | 📅 2026-09-17 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,938 | 🐛 3,229 | 🌐 Go | 📅 2026-09-17 - Modern *SSH* server for clusters and teams.
...
* [whosthere](https://github.com/FiloSottile/whosthere) ⭐ 2,365 | 🐛 10 | 🌐 Go | 📅 2026-04-16 [![stars](https://img.shields.io/github/stars/FiloSottile/whosthere.svg?style=social\&label=stars)](https://github.com/FiloSottile/whosthere) ⭐ 2,365 | 🐛 10 | 🌐 Go | 📅 2026-04-16 - A *SSH* server that knows who you are. `$ ssh whoami.filippo.io`.
* [ShellHub](https://github.com/shellhub-io/shellhub) ⭐ 2,068 | 🐛 31 | 🌐 Go | 📅 2026-09-23 [![stars](https://img.shields.io/github/stars/shellhub-io/shellhub.svg?style=social\&label=stars)](https://github.com/shellhub-io/shellhub) ⭐ 2,068 | 🐛 31 | 🌐 Go | 📅 2026-09-23 - A *SSH* gateway for remotely accessing any Linux device behind firewall and NAT.
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,941 | 🐛 81 | 🌐 Go | 📅 2026-09-19 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,941 | 🐛 81 | 🌐 Go | 📅 2026-09-19 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [ssh2docker](https://github.com/moul/ssh2docker) ⭐ 198 | 🐛 24 | 🌐 Go | 📅 2026-09-19 [![stars](https://img.shields.io/github/stars/moul/ssh2docker.svg?style=social\&label=stars)](https://github.com/moul/ssh2docker) ⭐ 198 | 🐛 24 | 🌐 Go | 📅 2026-09-19 - *SSH* server to Docker containers.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,567 | 🐛 210 | 🌐 Python | 📅 2026-09-22 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,567 | 🐛 210 | 🌐 Python | 📅 2026-09-22 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,677 | 🐛 62 | 🌐 C | 📅 2026-09-16 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,677 | 🐛 62 | 🌐 C | 📅 2026-09-16 - Filesystem client based on the *SSH* File Transfer Protocol.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,117 | 🐛 47 | 🌐 C | 📅 2026-09-19 [![stars](https://img.shields.io/github/stars/yrutschle/sslh.svg?style=social\&label=stars)](https://github.com/yrutschle/sslh) ⭐ 5,117 | 🐛 47 | 🌐 C | 📅 2026-09-19 - Applicative Protocol Multiplexer (i.e: *SSH* + *HTTPS*).
...
* [wssh](https://github.com/aluzzardi/wssh) ⭐ 1,370 | 🐛 26 | 🌐 JavaScript | 📅 2019-02-12 [![stars](https://img.shields.io/github/stars/aluzzardi/wssh.svg?style=social\&label=stars)](https://github.com/aluzzardi/wssh) ⭐ 1,370 | 🐛 26 | 🌐 JavaScript | 📅 2019-02-12 - *SSH* to WebSockets Bridge.
* [sshpiper](https://github.com/tg123/sshpiper) ⭐ 1,321 | 🐛 23 | 🌐 Go | 📅 2026-09-23 [![stars](https://img.shields.io/github/stars/tg123/sshpiper.svg?style=social\&label=stars)](https://github.com/tg123/sshpiper) ⭐ 1,321 | 🐛 23 | 🌐 Go | 📅 2026-09-23 - The missing reverse proxy for ssh scp.
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,893 | 🐛 298 | 🌐 Shell | 📅 2026-09-23 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,893 | 🐛 298 | 🌐 Shell | 📅 2026-09-23 - `ssh-agent` plugin for `zsh`.
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,098 | 🐛 30 | 🌐 Python | 📅 2026-06-02 [![stars](https://img.shields.io/github/stars/xxh/xxh.svg?style=social\&label=stars)](https://github.com/xxh/xxh) ⭐ 6,098 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
...
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 [![stars](https://img.shields.io/github/stars/ssh-vault/ssh-vault.svg?style=social\&label=stars)](https://github.com/ssh-vault/ssh-vault) ⭐ 509 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 - encrypt/decrypt files using ssh keys
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,783 | 🐛 842 | 🌐 Python | 📅 2026-09-24 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,783 | 🐛 842 | 🌐 Python | 📅 2026-09-24 - App deployment, configuration management and orchestration over *SSH*.
...
* [KeyBox](https://github.com/skavanagh/KeyBox) ⭐ 3,551 | 🐛 130 | 🌐 Java | 📅 2026-09-21 [![stars](https://img.shields.io/github/stars/skavanagh/KeyBox.svg?style=social\&label=stars)](https://github.com/skavanagh/KeyBox) ⭐ 3,551 | 🐛 130 | 🌐 Java | 📅 2026-09-21 - Web-based *SSH* console that centrally manages administrative access to systems.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,548 | 🐛 68 | 🌐 Python | 📅 2026-09-21 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,548 | 🐛 68 | 🌐 Python | 📅 2026-09-21 - *SSH* Honeypot (based on kippo).
* [ssh-audit](https://github.com/arthepsy/ssh-audit) ⭐ 3,000 | 🐛 29 | 🌐 Python | 📅 2024-06-28 [![stars](https://img.shields.io/github/stars/arthepsy/ssh-audit.svg?style=social\&label=stars)](https://github.com/arthepsy/ssh-audit) ⭐ 3,000 | 🐛 29 | 🌐 Python | 📅 2024-06-28 - A tool for *SSH* server auditing.
...
* [kippo](https://github.com/desaster/kippo) ⭐ 1,713 | 🐛 83 | 🌐 Python | 📅 2023-11-19 [![stars](https://img.shields.io/github/stars/desaster/kippo.svg?style=social\&label=stars)](https://github.com/desaster/kippo) ⭐ 1,713 | 🐛 83 | 🌐 Python | 📅 2023-11-19 - *SSH* Honeypot.
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,411 | 🐛 115 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,411 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* Golang
  * [sftp](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 62 | 🌐 Go | 📅 2026-07-22 [![stars](https://img.shields.io/github/stars/pkg/sftp.svg?style=social\&label=stars)](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 62 | 🌐 Go | 📅 2026-07-22 - *SFTP* support for the go.crypto/ssh package.
...
* Javascript/Node.js
  * [ssh2](https://github.com/mscdex/ssh2) ⭐ 5,822 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/mscdex/ssh2.svg?style=social\&label=stars)](https://github.com/mscdex/ssh2) ⭐ 5,822 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-20 - *SSH2* client and server modules written in pure *JavaScript* for *node.js*.
* Python
  * [paramiko](https://github.com/paramiko/paramiko) ⭐ 9,861 | 🐛 1,197 | 🌐 Python | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/paramiko/paramiko.svg?style=social\&label=stars)](https://github.com/paramiko/paramiko) ⭐ 9,861 | 🐛 1,197 | 🌐 Python | 📅 2026-08-29 - Native *Python* *SSHv2* protocol library.
* Ruby
