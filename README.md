...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,044 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-03 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,894 | 🐛 3,322 | 🌐 Go | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,894 | 🐛 3,322 | 🌐 Go | 📅 2026-09-07 - Modern *SSH* server for clusters and teams.
...
* [ShellHub](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-08 [![stars](https://img.shields.io/github/stars/shellhub-io/shellhub.svg?style=social\&label=stars)](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-08 - A *SSH* gateway for remotely accessing any Linux device behind firewall and NAT.
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,940 | 🐛 81 | 🌐 Go | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,940 | 🐛 81 | 🌐 Go | 📅 2026-09-03 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [sshcommand](https://github.com/dokku/sshcommand) ⭐ 388 | 🐛 1 | 🌐 Shell | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/dokku/sshcommand.svg?style=social\&label=stars)](https://github.com/dokku/sshcommand) ⭐ 388 | 🐛 1 | 🌐 Shell | 📅 2026-09-07 - Turn *SSH* into a thin client specifically for your app.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,544 | 🐛 212 | 🌐 Python | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,544 | 🐛 212 | 🌐 Python | 📅 2026-09-07 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,660 | 🐛 62 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,660 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
...
* [sshpiper](https://github.com/tg123/sshpiper) ⭐ 1,313 | 🐛 22 | 🌐 Go | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/tg123/sshpiper.svg?style=social\&label=stars)](https://github.com/tg123/sshpiper) ⭐ 1,313 | 🐛 22 | 🌐 Go | 📅 2026-09-07 - The missing reverse proxy for ssh scp.
...
* [quicssh](https://github.com/moul/quicssh) ⭐ 862 | 🐛 22 | 🌐 Go | 📅 2026-09-02 [![stars](https://img.shields.io/github/stars/moul/quicssh.svg?style=social\&label=stars)](https://github.com/moul/quicssh) ⭐ 862 | 🐛 22 | 🌐 Go | 📅 2026-09-02 - QUIC proxy for SSH
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,625 | 🐛 430 | 🌐 Shell | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,625 | 🐛 430 | 🌐 Shell | 📅 2026-09-07 - `ssh-agent` plugin for `zsh`.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,620 | 🐛 845 | 🌐 Python | 📅 2026-09-04 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,620 | 🐛 845 | 🌐 Python | 📅 2026-09-04 - App deployment, configuration management and orchestration over *SSH*.
...
* [KeyBox](https://github.com/skavanagh/KeyBox) ⭐ 3,544 | 🐛 136 | 🌐 Java | 📅 2026-09-08 [![stars](https://img.shields.io/github/stars/skavanagh/KeyBox.svg?style=social\&label=stars)](https://github.com/skavanagh/KeyBox) ⭐ 3,544 | 🐛 136 | 🌐 Java | 📅 2026-09-08 - Web-based *SSH* console that centrally manages administrative access to systems.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,523 | 🐛 86 | 🌐 Python | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,523 | 🐛 86 | 🌐 Python | 📅 2026-09-07 - *SSH* Honeypot (based on kippo).
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,549 | 🐛 158 | 🌐 Go | 📅 2024-08-01 [![stars](https://img.shields.io/github/stars/yudai/gotty.svg?style=social\&label=stars)](https://github.com/yudai/gotty) ⭐ 19,549 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Share your terminal as web application.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,326 | 🐛 113 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,326 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* Javascript/Node.js
  * [ssh2](https://github.com/mscdex/ssh2) ⭐ 5,820 | 🐛 105 | 🌐 JavaScript | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/mscdex/ssh2.svg?style=social\&label=stars)](https://github.com/mscdex/ssh2) ⭐ 5,820 | 🐛 105 | 🌐 JavaScript | 📅 2026-08-20 - *SSH2* client and server modules written in pure *JavaScript* for *node.js*.
* Python
  * [paramiko](https://github.com/paramiko/paramiko) ⭐ 9,842 | 🐛 1,191 | 🌐 Python | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/paramiko/paramiko.svg?style=social\&label=stars)](https://github.com/paramiko/paramiko) ⭐ 9,842 | 🐛 1,191 | 🌐 Python | 📅 2026-08-29 - Native *Python* *SSHv2* protocol library.
* Ruby
