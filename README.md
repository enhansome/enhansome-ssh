...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,234 | 🐛 105 | 📅 2026-08-21 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-08-30 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-08-30 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,858 | 🐛 3,331 | 🌐 Go | 📅 2026-08-28 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,858 | 🐛 3,331 | 🌐 Go | 📅 2026-08-28 - Modern *SSH* server for clusters and teams.
...
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,940 | 🐛 81 | 🌐 Go | 📅 2026-08-30 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,940 | 🐛 81 | 🌐 Go | 📅 2026-08-30 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,533 | 🐛 212 | 🌐 Python | 📅 2026-08-28 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,533 | 🐛 212 | 🌐 Python | 📅 2026-08-28 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,643 | 🐛 62 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,643 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
...
* [quicssh](https://github.com/moul/quicssh) ⭐ 860 | 🐛 22 | 🌐 Go | 📅 2026-08-28 [![stars](https://img.shields.io/github/stars/moul/quicssh.svg?style=social\&label=stars)](https://github.com/moul/quicssh) ⭐ 860 | 🐛 22 | 🌐 Go | 📅 2026-08-28 - QUIC proxy for SSH
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,450 | 🐛 576 | 🌐 Shell | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,450 | 🐛 576 | 🌐 Shell | 📅 2026-08-29 - `ssh-agent` plugin for `zsh`.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,497 | 🐛 836 | 🌐 Python | 📅 2026-08-27 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,497 | 🐛 836 | 🌐 Python | 📅 2026-08-27 - App deployment, configuration management and orchestration over *SSH*.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,510 | 🐛 119 | 🌐 Python | 📅 2026-08-27 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,510 | 🐛 119 | 🌐 Python | 📅 2026-08-27 - *SSH* Honeypot (based on kippo).
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,278 | 🐛 113 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,278 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
