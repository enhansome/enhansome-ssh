...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,145 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-14 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,917 | 🐛 3,262 | 🌐 Go | 📅 2026-09-11 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,917 | 🐛 3,262 | 🌐 Go | 📅 2026-09-11 - Modern *SSH* server for clusters and teams.
...
* [ShellHub](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/shellhub-io/shellhub.svg?style=social\&label=stars)](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-15 - A *SSH* gateway for remotely accessing any Linux device behind firewall and NAT.
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-14 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,560 | 🐛 211 | 🌐 Python | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,560 | 🐛 211 | 🌐 Python | 📅 2026-09-14 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,668 | 🐛 64 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,668 | 🐛 64 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,113 | 🐛 49 | 🌐 C | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/yrutschle/sslh.svg?style=social\&label=stars)](https://github.com/yrutschle/sslh) ⭐ 5,113 | 🐛 49 | 🌐 C | 📅 2026-08-20 - Applicative Protocol Multiplexer (i.e: *SSH* + *HTTPS*).
...
* [quicssh](https://github.com/moul/quicssh) ⭐ 864 | 🐛 22 | 🌐 Go | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/moul/quicssh.svg?style=social\&label=stars)](https://github.com/moul/quicssh) ⭐ 864 | 🐛 22 | 🌐 Go | 📅 2026-09-14 - QUIC proxy for SSH
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,723 | 🐛 326 | 🌐 Shell | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,723 | 🐛 326 | 🌐 Shell | 📅 2026-09-14 - `ssh-agent` plugin for `zsh`.
...
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 2 | 🌐 Rust | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/ssh-vault/ssh-vault.svg?style=social\&label=stars)](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 2 | 🌐 Rust | 📅 2026-09-14 - encrypt/decrypt files using ssh keys
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,687 | 🐛 824 | 🌐 Python | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,687 | 🐛 824 | 🌐 Python | 📅 2026-09-14 - App deployment, configuration management and orchestration over *SSH*.
...
* [KeyBox](https://github.com/skavanagh/KeyBox) ⭐ 3,545 | 🐛 133 | 🌐 Java | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/skavanagh/KeyBox.svg?style=social\&label=stars)](https://github.com/skavanagh/KeyBox) ⭐ 3,545 | 🐛 133 | 🌐 Java | 📅 2026-09-15 - Web-based *SSH* console that centrally manages administrative access to systems.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,537 | 🐛 68 | 🌐 Python | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,537 | 🐛 68 | 🌐 Python | 📅 2026-09-15 - *SSH* Honeypot (based on kippo).
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,367 | 🐛 115 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,367 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* Python
  * [paramiko](https://github.com/paramiko/paramiko) ⭐ 9,853 | 🐛 1,193 | 🌐 Python | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/paramiko/paramiko.svg?style=social\&label=stars)](https://github.com/paramiko/paramiko) ⭐ 9,853 | 🐛 1,193 | 🌐 Python | 📅 2026-08-29 - Native *Python* *SSHv2* protocol library.
* Ruby
