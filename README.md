...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,483 | 🐛 105 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-09-03 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,877 | 🐛 3,325 | 🌐 Go | 📅 2026-09-02 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,877 | 🐛 3,325 | 🌐 Go | 📅 2026-09-02 - Modern *SSH* server for clusters and teams.
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,536 | 🐛 212 | 🌐 Python | 📅 2026-08-31 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,536 | 🐛 212 | 🌐 Python | 📅 2026-08-31 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,652 | 🐛 61 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,652 | 🐛 61 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,109 | 🐛 48 | 🌐 C | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/yrutschle/sslh.svg?style=social\&label=stars)](https://github.com/yrutschle/sslh) ⭐ 5,109 | 🐛 48 | 🌐 C | 📅 2026-08-20 - Applicative Protocol Multiplexer (i.e: *SSH* + *HTTPS*).
...
* [sshpiper](https://github.com/tg123/sshpiper) ⭐ 1,308 | 🐛 25 | 🌐 Go | 📅 2026-09-02 [![stars](https://img.shields.io/github/stars/tg123/sshpiper.svg?style=social\&label=stars)](https://github.com/tg123/sshpiper) ⭐ 1,308 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - The missing reverse proxy for ssh scp.
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,512 | 🐛 576 | 🌐 Shell | 📅 2026-09-01 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,512 | 🐛 576 | 🌐 Shell | 📅 2026-09-01 - `ssh-agent` plugin for `zsh`.
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,081 | 🐛 30 | 🌐 Python | 📅 2026-06-02 [![stars](https://img.shields.io/github/stars/xxh/xxh.svg?style=social\&label=stars)](https://github.com/xxh/xxh) ⭐ 6,081 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,564 | 🐛 833 | 🌐 Python | 📅 2026-09-02 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,564 | 🐛 833 | 🌐 Python | 📅 2026-09-02 - App deployment, configuration management and orchestration over *SSH*.
...
* [KeyBox](https://github.com/skavanagh/KeyBox) ⭐ 3,542 | 🐛 131 | 🌐 Java | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/skavanagh/KeyBox.svg?style=social\&label=stars)](https://github.com/skavanagh/KeyBox) ⭐ 3,542 | 🐛 131 | 🌐 Java | 📅 2026-09-03 - Web-based *SSH* console that centrally manages administrative access to systems.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,512 | 🐛 115 | 🌐 Python | 📅 2026-08-31 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,512 | 🐛 115 | 🌐 Python | 📅 2026-08-31 - *SSH* Honeypot (based on kippo).
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,295 | 🐛 114 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,295 | 🐛 114 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* Python
  * [paramiko](https://github.com/paramiko/paramiko) ⭐ 9,843 | 🐛 1,192 | 🌐 Python | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/paramiko/paramiko.svg?style=social\&label=stars)](https://github.com/paramiko/paramiko) ⭐ 9,843 | 🐛 1,192 | 🌐 Python | 📅 2026-08-29 - Native *Python* *SSHv2* protocol library.
* Ruby
