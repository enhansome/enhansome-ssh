...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,916 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-09-08 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,221 | 🐛 100 | 🌐 Go | 📅 2026-09-08 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,910 | 🐛 3,330 | 🌐 Go | 📅 2026-09-10 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,910 | 🐛 3,330 | 🌐 Go | 📅 2026-09-10 - Modern *SSH* server for clusters and teams.
* [ssh-chat](https://github.com/shazow/ssh-chat) ⭐ 5,909 | 🐛 54 | 🌐 Go | 📅 2026-01-10 [![stars](https://img.shields.io/github/stars/shazow/ssh-chat.svg?style=social\&label=stars)](https://github.com/shazow/ssh-chat) ⭐ 5,909 | 🐛 54 | 🌐 Go | 📅 2026-01-10 - Chat over *SSH*.
* [whosthere](https://github.com/FiloSottile/whosthere) ⭐ 2,363 | 🐛 10 | 🌐 Go | 📅 2026-04-16 [![stars](https://img.shields.io/github/stars/FiloSottile/whosthere.svg?style=social\&label=stars)](https://github.com/FiloSottile/whosthere) ⭐ 2,363 | 🐛 10 | 🌐 Go | 📅 2026-04-16 - A *SSH* server that knows who you are. `$ ssh whoami.filippo.io`.
* [ShellHub](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-10 [![stars](https://img.shields.io/github/stars/shellhub-io/shellhub.svg?style=social\&label=stars)](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-10 - A *SSH* gateway for remotely accessing any Linux device behind firewall and NAT.
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-08 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-08 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,548 | 🐛 212 | 🌐 Python | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,548 | 🐛 212 | 🌐 Python | 📅 2026-09-07 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,664 | 🐛 62 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,664 | 🐛 62 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,112 | 🐛 49 | 🌐 C | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/yrutschle/sslh.svg?style=social\&label=stars)](https://github.com/yrutschle/sslh) ⭐ 5,112 | 🐛 49 | 🌐 C | 📅 2026-08-20 - Applicative Protocol Multiplexer (i.e: *SSH* + *HTTPS*).
* [localtunnel](https://github.com/progrium/localtunnel) ⭐ 3,228 | 🐛 13 | 🌐 Go | 📅 2022-05-17 [![stars](https://img.shields.io/github/stars/progrium/localtunnel.svg?style=social\&label=stars)](https://github.com/progrium/localtunnel) ⭐ 3,228 | 🐛 13 | 🌐 Go | 📅 2022-05-17 - Expose localhost servers to the Internet.
* [wssh](https://github.com/aluzzardi/wssh) ⭐ 1,372 | 🐛 26 | 🌐 JavaScript | 📅 2019-02-12 [![stars](https://img.shields.io/github/stars/aluzzardi/wssh.svg?style=social\&label=stars)](https://github.com/aluzzardi/wssh) ⭐ 1,372 | 🐛 26 | 🌐 JavaScript | 📅 2019-02-12 - *SSH* to WebSockets Bridge.
* [sshpiper](https://github.com/tg123/sshpiper) ⭐ 1,314 | 🐛 23 | 🌐 Go | 📅 2026-09-09 [![stars](https://img.shields.io/github/stars/tg123/sshpiper.svg?style=social\&label=stars)](https://github.com/tg123/sshpiper) ⭐ 1,314 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - The missing reverse proxy for ssh scp.
...
* [quicssh](https://github.com/moul/quicssh) ⭐ 864 | 🐛 22 | 🌐 Go | 📅 2026-09-02 [![stars](https://img.shields.io/github/stars/moul/quicssh.svg?style=social\&label=stars)](https://github.com/moul/quicssh) ⭐ 864 | 🐛 22 | 🌐 Go | 📅 2026-09-02 - QUIC proxy for SSH
...
* [clusterssh](https://github.com/duncs/clusterssh) ⭐ 989 | 🐛 28 | 🌐 Perl | 📅 2026-04-28 [![stars](https://img.shields.io/github/stars/duncs/clusterssh.svg?style=social\&label=stars)](https://github.com/duncs/clusterssh) ⭐ 989 | 🐛 28 | 🌐 Perl | 📅 2026-04-28 - Cluster admin via *SSH*.
...
* [totp-ssh-fluxer](https://github.com/benjojo/totp-ssh-fluxer) ⭐ 946 | 🐛 2 | 🌐 Go | 📅 2022-08-31 [![stars](https://img.shields.io/github/stars/benjojo/totp-ssh-fluxer.svg?style=social\&label=stars)](https://github.com/benjojo/totp-ssh-fluxer) ⭐ 946 | 🐛 2 | 🌐 Go | 📅 2022-08-31 - A way to make sure your `sshd` port changes every 30 seconds.
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,660 | 🐛 335 | 🌐 Shell | 📅 2026-09-10 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,660 | 🐛 335 | 🌐 Shell | 📅 2026-09-10 - `ssh-agent` plugin for `zsh`.
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,085 | 🐛 30 | 🌐 Python | 📅 2026-06-02 [![stars](https://img.shields.io/github/stars/xxh/xxh.svg?style=social\&label=stars)](https://github.com/xxh/xxh) ⭐ 6,085 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
...
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/ssh-vault/ssh-vault.svg?style=social\&label=stars)](https://github.com/ssh-vault/ssh-vault) ⭐ 508 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - encrypt/decrypt files using ssh keys
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,639 | 🐛 837 | 🌐 Python | 📅 2026-09-10 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,639 | 🐛 837 | 🌐 Python | 📅 2026-09-10 - App deployment, configuration management and orchestration over *SSH*.
...
* [KeyBox](https://github.com/skavanagh/KeyBox) ⭐ 3,545 | 🐛 130 | 🌐 Java | 📅 2026-09-10 [![stars](https://img.shields.io/github/stars/skavanagh/KeyBox.svg?style=social\&label=stars)](https://github.com/skavanagh/KeyBox) ⭐ 3,545 | 🐛 130 | 🌐 Java | 📅 2026-09-10 - Web-based *SSH* console that centrally manages administrative access to systems.
* [SSHmon](https://github.com/hpello/sshmon) ⭐ 206 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 [![stars](https://img.shields.io/github/stars/hpello/sshmon.svg?style=social\&label=stars)](https://github.com/hpello/sshmon) ⭐ 206 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 - Real-time GUI to monitor SSH connections and establish port forwardings.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,528 | 🐛 87 | 🌐 Python | 📅 2026-09-07 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,528 | 🐛 87 | 🌐 Python | 📅 2026-09-07 - *SSH* Honeypot (based on kippo).
* [ssh-audit](https://github.com/arthepsy/ssh-audit) ⭐ 2,996 | 🐛 31 | 🌐 Python | 📅 2024-06-28 [![stars](https://img.shields.io/github/stars/arthepsy/ssh-audit.svg?style=social\&label=stars)](https://github.com/arthepsy/ssh-audit) ⭐ 2,996 | 🐛 31 | 🌐 Python | 📅 2024-06-28 - A tool for *SSH* server auditing.
* [sshesame](https://github.com/jaksi/sshesame) ⭐ 1,742 | 🐛 17 | 🌐 Go | 📅 2024-10-21 [![stars](https://img.shields.io/github/stars/jaksi/sshesame.svg?style=social\&label=stars)](https://github.com/jaksi/sshesame) ⭐ 1,742 | 🐛 17 | 🌐 Go | 📅 2024-10-21 - A fake SSH server that lets everyone in and logs their activity.
...
* [GoTTY](https://github.com/yudai/gotty) ⭐ 19,550 | 🐛 158 | 🌐 Go | 📅 2024-08-01 [![stars](https://img.shields.io/github/stars/yudai/gotty.svg?style=social\&label=stars)](https://github.com/yudai/gotty) ⭐ 19,550 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Share your terminal as web application.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,346 | 🐛 113 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,346 | 🐛 113 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* Golang
  * [sftp](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 60 | 🌐 Go | 📅 2026-07-22 [![stars](https://img.shields.io/github/stars/pkg/sftp.svg?style=social\&label=stars)](https://github.com/pkg/sftp) ⭐ 1,663 | 🐛 60 | 🌐 Go | 📅 2026-07-22 - *SFTP* support for the go.crypto/ssh package.
...
* Javascript/Node.js
  * [ssh2](https://github.com/mscdex/ssh2) ⭐ 5,820 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/mscdex/ssh2.svg?style=social\&label=stars)](https://github.com/mscdex/ssh2) ⭐ 5,820 | 🐛 106 | 🌐 JavaScript | 📅 2026-08-20 - *SSH2* client and server modules written in pure *JavaScript* for *node.js*.
* Python
  * [paramiko](https://github.com/paramiko/paramiko) ⭐ 9,848 | 🐛 1,192 | 🌐 Python | 📅 2026-08-29 [![stars](https://img.shields.io/github/stars/paramiko/paramiko.svg?style=social\&label=stars)](https://github.com/paramiko/paramiko) ⭐ 9,848 | 🐛 1,192 | 🌐 Python | 📅 2026-08-29 - Native *Python* *SSHv2* protocol library.
* Ruby
