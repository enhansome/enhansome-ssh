...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,474 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [`assh`](https://github.com/moul/assh) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-16 [![stars](https://img.shields.io/github/stars/moul/advanced-ssh-config.svg?style=social\&label=stars)](https://github.com/moul/advanced-ssh-config) ⭐ 3,220 | 🐛 100 | 🌐 Go | 📅 2026-09-16 - Transparent wrapper (ProxyCommand) that adds regex, aliases, gateways, includes, dynamic hostnames to *SSH* and `ssh-config`. *Previously: `advanced-ssh-config`*
...
* [teleport](https://github.com/gravitational/teleport) ⭐ 20,922 | 🐛 3,263 | 🌐 Go | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/gravitational/teleport.svg?style=social\&label=stars)](https://github.com/gravitational/teleport) ⭐ 20,922 | 🐛 3,263 | 🌐 Go | 📅 2026-09-15 - Modern *SSH* server for clusters and teams.
...
* [ShellHub](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-16 [![stars](https://img.shields.io/github/stars/shellhub-io/shellhub.svg?style=social\&label=stars)](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-16 - A *SSH* gateway for remotely accessing any Linux device behind firewall and NAT.
* [sshportal](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-16 [![stars](https://img.shields.io/github/stars/moul/sshportal.svg?style=social\&label=stars)](https://github.com/moul/sshportal) ⭐ 1,939 | 🐛 81 | 🌐 Go | 📅 2026-09-16 - simple, fun, and transparent SSH (& Telnet) Bastion Server
...
* [sshuttle](https://github.com/sshuttle/sshuttle) ⭐ 13,564 | 🐛 211 | 🌐 Python | 📅 2026-09-14 [![stars](https://img.shields.io/github/stars/sshuttle/sshuttle.svg?style=social\&label=stars)](https://github.com/sshuttle/sshuttle) ⭐ 13,564 | 🐛 211 | 🌐 Python | 📅 2026-09-14 - Transparent proxy server that works as a poor man's *VPN*. Forwards over `ssh`. Doesn't require admin. Works with *Linux* and *MacOS*. Supports *DNS tunneling*.
* [sshfs](https://github.com/libfuse/sshfs) ⭐ 7,667 | 🐛 64 | 🌐 C | 📅 2026-08-08 [![stars](https://img.shields.io/github/stars/libfuse/sshfs.svg?style=social\&label=stars)](https://github.com/libfuse/sshfs) ⭐ 7,667 | 🐛 64 | 🌐 C | 📅 2026-08-08 - Filesystem client based on the *SSH* File Transfer Protocol.
* [sslh](https://github.com/yrutschle/sslh) ⭐ 5,114 | 🐛 49 | 🌐 C | 📅 2026-08-20 [![stars](https://img.shields.io/github/stars/yrutschle/sslh.svg?style=social\&label=stars)](https://github.com/yrutschle/sslh) ⭐ 5,114 | 🐛 49 | 🌐 C | 📅 2026-08-20 - Applicative Protocol Multiplexer (i.e: *SSH* + *HTTPS*).
...
* [sshpiper](https://github.com/tg123/sshpiper) ⭐ 1,316 | 🐛 23 | 🌐 Go | 📅 2026-09-09 [![stars](https://img.shields.io/github/stars/tg123/sshpiper.svg?style=social\&label=stars)](https://github.com/tg123/sshpiper) ⭐ 1,316 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - The missing reverse proxy for ssh scp.
...
* [oh-my-zsh/plugins/ssh-agent](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,746 | 🐛 317 | 🌐 Shell | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/robbyrussell/oh-my-zsh.svg?style=social\&label=stars)](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,746 | 🐛 317 | 🌐 Shell | 📅 2026-09-15 - `ssh-agent` plugin for `zsh`.
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,091 | 🐛 30 | 🌐 Python | 📅 2026-06-02 [![stars](https://img.shields.io/github/stars/xxh/xxh.svg?style=social\&label=stars)](https://github.com/xxh/xxh) ⭐ 6,091 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the ssh.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,694 | 🐛 831 | 🌐 Python | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/ansible/ansible.svg?style=social\&label=stars)](https://github.com/ansible/ansible) ⭐ 70,694 | 🐛 831 | 🌐 Python | 📅 2026-09-15 - App deployment, configuration management and orchestration over *SSH*.
...
* [cowrie](https://github.com/micheloosterhof/cowrie) ⭐ 6,537 | 🐛 64 | 🌐 Python | 📅 2026-09-15 [![stars](https://img.shields.io/github/stars/micheloosterhof/cowrie.svg?style=social\&label=stars)](https://github.com/micheloosterhof/cowrie) ⭐ 6,537 | 🐛 64 | 🌐 Python | 📅 2026-09-15 - *SSH* Honeypot (based on kippo).
...
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,375 | 🐛 115 | 🌐 C | 📅 2026-08-12 [![stars](https://img.shields.io/github/stars/tsl0922/ttyd.svg?style=social\&label=stars)](https://github.com/tsl0922/ttyd) ⭐ 12,375 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
